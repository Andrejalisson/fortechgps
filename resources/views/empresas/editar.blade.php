                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="/Empresas/Perfil/{{$empresa->id}}">Perfil</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="#">Edição</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
										...
										<div id="kt_account_settings_profile_details" class="collapse show">
											...
											<form id="kt_account_profile_details_form" class="form">
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8">
															...
															<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                                                ...
                                                                @if (is_null($empresa->logo))
                                                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url(/assets/media/avatars/empresaBlank.png)"></div>
                                                                @else
                                                                    <img src="/assets/media/avatars/empresssasaBlank.png" alt="image" />
                                                                @endif
															...
															<!--end::Image input-->
															<!--begin::Hint-->
															<div class="form-text">Adicionar arquivos no formato: png, jpg, jpeg.</div>
															<!--end::Hint-->
														</div>
														<!--end::Col-->
													</div>
													...
													<div class="row mb-6">
														<!--begin::Label-->
														<label class="col-lg-4 col-form-label required fw-semibold fs-6">Razão Social</label>
														<!--end::Label-->
														<!--begin::Col-->
														<div class="col-lg-8">
															<!--begin::Row-->
															<div class="row">
																...
																<div class="col-lg-12 fv-row">
																	<input type="text" name="rsocial" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Razão Social" value="{{$empresa->name}}" />
																</div>
																<!--end::Col-->
															</div>
															<!--end::Row-->
