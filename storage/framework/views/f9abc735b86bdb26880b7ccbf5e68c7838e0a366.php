...
<head>
    ...
    <title><?php echo e($title); ?> | Fortech GPS Rastreamento Veicular</title>
...
<div class="page-wrapper">
    ...
    <footer class="site-footer">
        ...
        <div class="bottom-footer text-center">
            <div class="container">
                <p><a href="/">Fortech GPS</a> &copy; <?php echo e(date('Y')); ?> Todos os direitos reservados.</p>
            </div><!-- /.container -->
        </div><!-- /.bottom-footer -->
    </footer><!-- /.site-footer -->
</div><!-- /.page-wrapper -->
...
<?php /**PATH C:\Users\t_jalisson\Documents\fortechgps\resources\views/site/templates/site.blade.php ENDPATH**/ ?>